...
function selectTyp() {                                                           // Funktion 2017020801
  global $selTyp;                                                               // Daten für SELECT Auswahl
  $selTyp = ("SELECT * FROM unittypen");                                        // aus unittypen holen
  return $selTyp;                                                               // Funktion 2017020801
}
