...
<div class="jumbotron text-left">
     <div class="container">
          <h1 class="mod1">Neue Kontaktperson für Kunden anlegen
     </div> 
</div>            
<div class="container">
     <div class="row">
      <div class="col-md-2">Test</div>      <!-- Aufteilung der Seite in 2 Teile LINKS ist frei zur Verfügung -->
        <div class="col-md-10">             <!-- Beginn der zweiten Spalte -->
          <div class="panel panel-info box-border">
            <div class="panel-heading">Kontaktperson Kunde anlegen</div>
              <div class="panel-body panel-info">
                 
                <!-- Anfang Formular -->
<form class="form-horizontal" role="form" id ="form" name="form" action="send_formdata_Kontakt_Kunde.php" method="POST" >

<div class="form-group">
  <label for="Firma" class="col-sm-2 control-label">Kunde</label>
    <div class="col-sm-10">
      <div class="input-group">
       <div class="input-group-addon">
        <i class="fa fa-hashtag fa-fw"></i> 
       </div> 
        <select type="text" class="form-control" name="selectname" id="name" value="<?php echo $endresult['id'];?>" autofocus="" placeholder="Firma" />
<?php  
        customer();                                                             // Function Nr.: 23020802 $dort 
        $ergebnisvonKunde= $db->query($dort);
        // Ausgabe über while Schleife, da mehr als ein Ergebnis erwartet wird
        while($endresult = $ergebnisvonKunde->fetch_array() ) {
        echo "<option> ID:{$endresult['id']} | KD.Nr:{$endresult['cs_id']} | {$endresult['cs_customer_name']}</option>"; }
?>
        </select>  
      </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
     ...
     <i class="fa fa-fax fa-fw"></i>
      ...
      <input type="digits" class="form-control" name="fax" id="fax" placeholder="Faxnummer" />
      </div>
        <!--Ausgabe Fehlermeldung -->                                                                    
        <div class="help-block"></div>  
            <!--Ende Ausgabe -->
