...
<div class="jumbotron text-left">
  ...
  <div class="panel-heading">Kunden anlegen</div>
    ...
    <div class="col-sm-10">
     <div class="input-group">
      <div class="input-group-addon">
       ...
       <input type="text" class="form-control" name="k_name_company" required="" data-toggle="tooltip" title="Bei Privatperson vollständigen Namen angeben!" id="firma" data-required-error="Pflichtfeld" placeholder="Firmenname oder vollen Vor-, Nachnamen" />
     </div>
        <!--Ausgabe Fehlermeldung -->                                                                    
        <div class="help-block with-errors"></div>
        <!--Ende Ausgabe -->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
     <div class="input-group">
      ...
      <input type="text" class="form-control" name="k_street" required="" id="street" data-required-error="Pflichtfeld" placeholder="Strasse" />
     </div>
      <!--Ausgabe Fehlermeldung -->                                                                    
       <div class="help-block with-errors"></div> 
      <!--Ende Ausgabe -->
